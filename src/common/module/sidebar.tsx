...
import { ChartIcon, TallbarIcon } from "../../../public/icons/icons";
...
function Sidebar() {
    ...
    const menus: ISubmenu[] = [
        { id: 1, title: "login", icon: <ChartIcon />, address: () => router.push(`/`) },
        { id: 2, title: "dashboard", icon: <ChartIcon />, address: () => showSubMenu(1) },
        { id: 3, title: "news", icon: <ChartIcon />, address: () => router.push(`${PG.SUCCESS}/news`) },
        { id: 4, title: "chatting", icon: <ChartIcon />, address: () => router.push(`${PG.SUCCESS}/chatting/1111`) },
        { id: 5, title: "관리자 문의", icon: <ChartIcon />, address: () => router.push(`${PG.SUCCESS}/boardlist`) },
    ]
